export const weekZeroQuizQuestions = Object.freeze([
  ...
  { id: 'w0q10', conceptIds: ['w0-evidence'], difficulty: 'application', remediationModuleIds: ['w0-evidence'], question: '엑셀에서 직무-공고 매핑은 320개지만 고유 URL은 290개인 이유는?', options: ['30개 공고에 URL이 없어서', '한 공고가 여러 대표 직무의 실제 책임을 포함해 복수 매핑된 경우가 있어서', '국내 공고는 URL로 세지 않아서'], answer: 1, explanation: '같은 공고가 여러 대표 직무에 연결된 경우가 있으므로 매핑 수와 중복을 제거한 고유 URL 수를 구분합니다.' },
  ...
  { id: 'w0q12', conceptIds: ['w0-evidence'], difficulty: 'analysis', remediationModuleIds: ['w0-evidence'], question: '최종 링크 상태가 “직접 공고 페이지 열림”일 때 가장 정확한 해석은?', options: ['2026년 내내 모집 중임이 보장된다', '확인일에 제목·본문 또는 지원 화면이 렌더링됐으며 현재 모집 여부는 다시 확인해야 한다', '지원 자격과 업무 본문을 모두 정규화했다'], answer: 1, explanation: '직접 페이지가 열린 사실과 현재 접수 중이라는 판단은 다릅니다. 공고를 사용할 시점에 모집 상태를 재확인해야 합니다.' },
  { id: 'w0q13', conceptIds: ['w0-evidence'], difficulty: 'analysis', remediationModuleIds: ['w0-evidence'], question: 'URL 자동 확인에 실패한 공고를 WEEK 0 화면에서 다루는 방법은?', options: ['정상 공고로 간주해 지원 링크를 표시한다', '마감 공고라고 확정한다', '검증 상태는 남기되 수동 확인 전까지 원 URL 링크를 숨긴다'], answer: 2, explanation: '자동 확인 실패는 정상이나 마감을 뜻하지 않으므로 보수적으로 비노출하고 수동 확인 대상으로 남깁니다.' },
])
